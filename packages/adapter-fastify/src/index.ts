...
import { EventOptions } from '@esliph/module/dist/common/event/decorator'
...
function onEvent(method: string, name: string, key: string, target: any, options: EventOptions = {}) {
    Metadata.Create.Method({ key: METADATA_ADAPTER_FASTIFY_HTTP_ROUTER_HANDLER_KEY, value: { event: name, method, options } }, target, key)
}
